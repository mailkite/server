// Docs: docs/dashboard/components/ui/dialog.md
// Generic modal dialog (radix Dialog) — the dismissible counterpart to alert-dialog (which is for
// confirmations). Used where a task needs room and a clear Cancel/confirm pair rather than a popover.
